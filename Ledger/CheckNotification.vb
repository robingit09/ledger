    ...
    Public Sub loadLedger(ByVal query As String)
        ...
        With db1
            ...
            While .dr.Read
                ...
                Dim dtp_check As New Date

                'check date remaining date encashment
                If Not IsDBNull(.dr.GetValue(9)) Then
                    dtp_check = .dr.GetValue(9)
                    remaining = Math.Floor(dtp_check.Subtract(DateTime.Now).TotalDays) + 1
                    If remaining < 0 Then
            ...
            Select Case k
                ...
                Case "remaining"
                    If cbRemaining.Text <> "All" Then
                        queryValidator = queryValidator & " and DateDiff('d',NOW(),[l.check_date]) " & remaining_val
                    End If
