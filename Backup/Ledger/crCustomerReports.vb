...
Public Class crCustomerReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ledger.crCustomerReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCustomerReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCustomerReports = New crCustomerReports
        rpt.Site = Me.Site
        Return rpt
    End Function
